...
This tiny repository-owned Helm chart creates a ConfigMap describing the selected slot. It exercises exact package/version/SHA binding, local values, reviewed common resources and repeatable Helm upgrade semantics without a vendor account. It is **not** an ingress controller or production monitoring installation.
